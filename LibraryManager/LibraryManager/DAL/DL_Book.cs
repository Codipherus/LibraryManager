...
namespace LibraryManager
{
    public static class DL_Book
    {
        ...
        public static List<Book> GetList()
        {
            ...
            var query = "SELECT m.Id, m.Title, a.FirstName + ' ' + a.LastName AS authorname, m.Length, m.Release, m.QtyTotal, m.QtyChecked, m.ISBN, m.AuthorID, m.GenreID, m.SubGenreID, m.PublisherID FROM media AS m LEFT JOIN author AS a ON m.AuthorID = a.AuthorID;";
